...
def netProduction(driver):
    ...
    netProdValue = driver.find_element_by_xpath("/html/body/div[1]/main/div[2]/div/div/div/div[2]/div/table/tbody/tr/td[5]/span/span[1]").text
...
def grossProduction(driver):
    ...
    grossProdValue = driver.find_element_by_xpath("/html/body/div[1]/main/div[2]/div/div/div/div[2]/div/table/tbody/tr/td[2]/span/span[1]").text
...
def adjustment(driver):
    ...
    adjustmentValue = driver.find_element_by_xpath("/html/body/div[1]/main/div[2]/div/div/div/div[2]/div/table/tbody/tr/td[3]/span/span[1]").text
